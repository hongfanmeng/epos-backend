...
export interface ApiOptionGroupOptionGroup extends CollectionTypeSchema {
  info: {
  ...
  attributes: {
    ...
    products: RelationAttribute<
      ...
      'api::product.product'
    >;
    minCount: IntegerAttribute &
      RequiredAttribute &
      SetMinMax<{
        min: 0;
      }> &
      DefaultTo<0>;
    maxCount: IntegerAttribute;
    options: ComponentAttribute<'product.product-option', true>;
    createdAt: DateTimeAttribute;
    updatedAt: DateTimeAttribute;
    publishedAt: DateTimeAttribute;
    createdBy: RelationAttribute<
...
export interface ApiOrderOrder extends CollectionTypeSchema {
  ...
  attributes: {
    remark: TextAttribute;
    subTotal: FloatAttribute;
    discount: FloatAttribute;
    extraFee: FloatAttribute;
    total: FloatAttribute;
    items: ComponentAttribute<'order.order-item', true>;
    createdAt: DateTimeAttribute;
    updatedAt: DateTimeAttribute;
    publishedAt: DateTimeAttribute;
    createdBy: RelationAttribute<
...
export interface ApiProductProduct extends CollectionTypeSchema {
  ...
  attributes: {
    ...
    isActive: BooleanAttribute & RequiredAttribute & DefaultTo<false>;
    ...
    optionGroups: RelationAttribute<
      'api::product.product',
      'manyToMany',
      'api::option-group.option-group'
    >;
...
export interface OrderOrderItem extends ComponentSchema {
  info: {
  ...
  attributes: {
    ...
    options: ComponentAttribute<'order.order-option', true>;
  };
}

export interface OrderOrderOption extends ComponentSchema {
  info: {
    displayName: 'Order Option';
    description: '';
  };
  attributes: {
    title: StringAttribute;
    groupTitle: StringAttribute;
  };
}

export interface ProductProductOption extends ComponentSchema {
  info: {
...
declare global {
  namespace Strapi {
    interface Schemas {
      ...
      'order.order-option': OrderOrderOption;
